...
2. 【**下载插件包**】插件最新版本见[**csgowiki-pack.zip**](https://github.com/csgowiki/csgowiki-pack/releases/latest)，国内用户可以在[**Gitee**](https://gitee.com/csgowiki/csgowiki-pack)获取更好的体验。
